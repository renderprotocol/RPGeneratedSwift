...
public nonisolated struct RPDivider: Sendable {
  ...
  public var indent: RPEdgeInsets {
    get {_indent ?? RPEdgeInsets()}
  ...
  fileprivate var _thickness: Float? = nil
  fileprivate var _color: RPColor? = nil
  fileprivate var _indent: RPEdgeInsets? = nil
}
...
nonisolated extension RPDivider: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".RPDivider"
  public static let _protobuf_nameMap = SwiftProtobuf._NameMap(bytecode: "\0\u{1}thickness\0\u{1}color\0\u{1}indent\0")
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularFloatField(value: &self._thickness) }()
      case 2: try { try decoder.decodeSingularMessageField(value: &self._color) }()
      case 3: try { try decoder.decodeSingularMessageField(value: &self._indent) }()
      default: break
      }
    }
  }
  ...
  public static func ==(lhs: RPDivider, rhs: RPDivider) -> Bool {
